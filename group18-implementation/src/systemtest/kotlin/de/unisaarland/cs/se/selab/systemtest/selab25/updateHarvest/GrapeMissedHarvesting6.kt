...
const val HARVEST_ESTIMATE = "[DEBUG] Harvest Estimate"
const val MISSED_HARVEST = "[DEBUG] Harvest Estimate: Required actions on tile 4 were not performed: HARVESTING."

/**
 * Test sowing a single WHEAT field at OCT1, machine returns to shed,
 * stats reflect remaining harvest.
 */
class GrapeMissedHarvesting6 : ExampleSystemTestExtension() {
    override val name = "when to log missed harvesting = check first and check second with numbers6"
