...
private const val SIM_TICK_6 = "[INFO] Simulation Info: Tick 6 started at tick 7 within the year."
private const val SIM_TICK_7 = "[INFO] Simulation Info: Tick 7 started at tick 8 within the year."
 ...
 * Example system test
 */
class MediumFullTest5 : ExampleSystemTestExtension() {
    override val name = "Medium all component tick 5 to 9"
    ...
    private val expectedLogs = listOf(
        ...
        "[INFO] Harvest Estimate: Harvest estimate on tile 18 changed to 388800 g of OAT.",
        ...
        "[INFO] Harvest Estimate: Harvest estimate on tile 18 changed to 314928 g of OAT.",
        ...
        "[INFO] Harvest Estimate: Harvest estimate on tile 18 changed to 206622 g of OAT.",
        ...
        "[DEBUG] Harvest Estimate: Required actions on tile 18 were not performed: WEEDING.",
        "[INFO] Harvest Estimate: Harvest estimate on tile 18 changed to 135563 g of OAT.",
        "[DEBUG] Harvest Estimate: Required actions on tile 19 were not performed: WEEDING.",
