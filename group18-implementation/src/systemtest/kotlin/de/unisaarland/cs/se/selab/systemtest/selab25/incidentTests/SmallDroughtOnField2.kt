 ...
 */
class SmallDroughtOnField2 : ExampleSystemTestExtension() { // I still need to check this.
    override val name = "SmallDroughtOnField2"
    ...
    override suspend fun run() {
        ...
        assertCurrentLine("[IMPORTANT] Incident: Incident 1 of type DROUGHT happened and affected tiles .")
    }
