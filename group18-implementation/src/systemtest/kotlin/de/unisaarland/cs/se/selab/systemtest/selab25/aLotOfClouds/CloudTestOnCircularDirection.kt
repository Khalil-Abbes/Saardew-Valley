 ...
 * Example system test
 */
class CloudTestOnCircularDirection : ExampleSystemTestExtension() {
    override val name = "CloudTestOnCircularDirection"
    ...
    private val expectedLogs = listOf(
        ...
        "[INFO] Harvest Estimate: Harvest estimate on tile 14 changed to 720000 g of ALMOND.",
