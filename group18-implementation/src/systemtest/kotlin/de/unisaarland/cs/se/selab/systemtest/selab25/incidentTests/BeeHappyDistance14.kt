 ...
 */
class BeeHappyDistance14 : ExampleSystemTestExtension() {
    override val name = "BeeHappyDistance[BUT WITH NO HOLES]14"
    ...
    override suspend fun run() {
        ...
        skipUntilString(HARVEST_ESTIMATE)
        assertCurrentLine("[INFO] Harvest Estimate: Harvest estimate on tile 6 changed to 1487160 g of APPLE.")
        skipUntilString(HARVEST_ESTIMATE)
