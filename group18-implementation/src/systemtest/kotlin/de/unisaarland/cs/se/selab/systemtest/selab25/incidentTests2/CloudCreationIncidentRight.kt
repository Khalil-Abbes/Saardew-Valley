 ...
 */
class CloudCreationIncidentRight : ExampleSystemTestExtension() {
    override val name = "Cloud Creation Incident Right"
    override val description = " Cloud should not dissipate on tiles without capacity and < 5000"
