 ...
 */
class BeeHappyDistance11 : ExampleSystemTestExtension() {
    override val name = "BeeHappyDistance[BUT WITH NO HOLES]11"
    ...
    override suspend fun run() {
        ...
        assertCurrentLine("[IMPORTANT] Incident: Incident 1 of type BEE_HAPPY happened and affected tiles 2, 6.")
        skipUntilString(INCIDENT)
        assertCurrentLine("[IMPORTANT] Incident: Incident 2 of type BEE_HAPPY happened and affected tiles 6, 14.")
    }
