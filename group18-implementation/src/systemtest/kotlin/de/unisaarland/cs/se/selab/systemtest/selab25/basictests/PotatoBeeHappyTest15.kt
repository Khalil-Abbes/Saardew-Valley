 ...
 * Example system test
 */
class PotatoBeeHappyTest15 : ExampleSystemTestExtension() {
    override val name = "PotatoBeeHappyTest15"
    override val description = "Test the interaction of BeeHappy and Potato (sowing 0, blooming 2, potato logged)"
