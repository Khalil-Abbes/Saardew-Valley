 ...
 * Example system test
 */
class PotatoBeeHappyTest11 : ExampleSystemTestExtension() {
    override val name = "PotatoBeeHappyTest11"
    override val description = "Test the interaction of BeeHappy and Potato (sowing 0, blooming 3, potato logged)"
