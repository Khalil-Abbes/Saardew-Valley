 ...
 * Example system test
 */
class DoubleFarmFullTick1HarvestEstimatePhaseApple : ExampleSystemTestExtension() {
    override val name = "test all component, double farm, tick 1, update harvest estimate phase Apple"
