 ...
 * Example system test
 */
class OnlyPlantationTest3 : ExampleSystemTestExtension() {
    override val name = "OnlyPlantationTest3"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Farm Machine: Machine 2 unloads 720000 g of ALMOND harvest in the shed.")
    }
}
