 ...
 * test actions
 */
class HarvestEstimateTick12Part11 : ExampleSystemTestExtension() {
    override val name = "Test Harvesting Estimate at tick 12 part 1, 1"
    ...
    override suspend fun run() {
        ...
        skipUntilString("[INFO] Harvest Estimate: Harvest estimate on tile 7 changed to 182188 g of PUMPKIN.")
        assertCurrentLine("[INFO] Harvest Estimate: Harvest estimate on tile 7 changed to 182188 g of PUMPKIN.")
