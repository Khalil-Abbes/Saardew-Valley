 ...
 */
class BeeHappyMoistureReductionToZeroThisTick1 : ExampleSystemTestExtension() {
    override val name = "BeeHappyMoistureReductionToZeroThisTick1"
    override val description = "Plantation with plant killed on the same tick " +
        "by moisture reduction to zero is affected by BeeHappy."
    ...
    override suspend fun run() {
        skipUntilString("[IMPORTANT] Incident: Incident 0 of type BEE_HAPPY happened and affected tiles 1.")
    }
