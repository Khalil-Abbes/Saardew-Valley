 ...
 */
class BeeHappyDistance21 : ExampleSystemTestExtension() {
    override val name = "BeeHappyDistance[BUT WITH NO HOLES]21"
    ...
    override suspend fun run() {
        ...
        assertCurrentLine("[IMPORTANT] Incident: Incident 1 of type BEE_HAPPY happened and affected tiles 2, 4, 6, 14.")
    }
