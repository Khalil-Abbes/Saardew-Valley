 ...
 * test actions
 */
class BasicMachineAction13 : ExampleSystemTestExtension() {
    override val name = "Basic Machine Test ticks 13-16"
    ...
    override suspend fun run() {
        ...
        skipUntilString(MACHINE_1_ACTION)
        assertCurrentLine("[IMPORTANT] Farm Action: Machine 1 performs WEEDING on tile 19 for 1 days.")
        skipUntilString(MACHINE_1_ACTION)
        assertCurrentLine("[IMPORTANT] Farm Action: Machine 1 performs WEEDING on tile 20 for 1 days.")
        skipUntilString(MACHINE_2_ACTION)
