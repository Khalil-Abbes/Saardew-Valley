 ...
 */
class MissedActionsLoggingAfterDroughtSameTick1 : ExampleSystemTestExtension() {
    override val name = "MissedActionsLoggingAfterDroughtSameTick1"
    override val description = "LOG missed actions after drought on the same tick"
