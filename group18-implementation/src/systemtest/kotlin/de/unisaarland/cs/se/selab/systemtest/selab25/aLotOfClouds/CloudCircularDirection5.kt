 ...
 * Example system test
 */
class CloudCircularDirection5 : ExampleSystemTestExtension() {
    ...
    override suspend fun run() {
        ...
        skipUntilLogType(LogLevel.INFO, LogType.SIMULATION_INFO)
        skipUntilString("[INFO] Harvest Estimate: Harvest estimate on tile 14 changed to 720000 g of ALMOND.")
    }
