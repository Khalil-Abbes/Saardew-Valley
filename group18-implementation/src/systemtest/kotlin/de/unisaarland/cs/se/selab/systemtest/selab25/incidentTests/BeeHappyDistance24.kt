 ...
 */
class BeeHappyDistance24 : ExampleSystemTestExtension() {
    override val name = "BeeHappyDistance[BUT WITH NO HOLES]24"
    ...
    override suspend fun run() {
        ...
        assertCurrentLine("[IMPORTANT] Incident: Incident 1 of type BEE_HAPPY happened and affected tiles 6.")
    }
