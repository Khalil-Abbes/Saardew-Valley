 ...
 * Example system test
 */
class WheatWeedingTest2 : ExampleSystemTestExtension() {
    override val name = "Wheat Weeding Test 2"
    override val description = "Test weeding after 3 tick, weed at tick 23 when sowed at tick 19"
