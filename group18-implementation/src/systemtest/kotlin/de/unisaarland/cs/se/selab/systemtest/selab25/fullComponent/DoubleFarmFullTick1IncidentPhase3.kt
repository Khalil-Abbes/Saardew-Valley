 ...
 * Example system test
 */
class DoubleFarmFullTick1IncidentPhase3 : ExampleSystemTestExtension() {
    override val name = "test all component, double farm, tick 1, incident phase cloud got stuck after city expansion"
