 ...
 * Example system test
 */
class PotatoBeeHappyTest1 : ExampleSystemTestExtension() {
    override val name = "PotatoBeeHappyTest1"
    override val description = "Test the interaction of BeeHappy and Potato (specific version : log but no tile)"
