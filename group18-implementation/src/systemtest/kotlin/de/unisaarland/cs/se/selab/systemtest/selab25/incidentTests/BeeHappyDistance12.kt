 ...
 */
class BeeHappyDistance12 : ExampleSystemTestExtension() {
    override val name = "BeeHappyDistance[BUT WITH NO HOLES]12"
    ...
    override suspend fun run() {
        ...
        skipUntilString(INCIDENT)
        assertCurrentLine("[IMPORTANT] Incident: Incident 2 of type BEE_HAPPY happened and affected tiles 14.")
    }
